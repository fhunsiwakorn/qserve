...
<option value="">--<?=$txt1?> <?=$ctgm_name_main_x?>--</option>
<?php
...
if($q != NULL ){
 $stateSQL="AND tbl_category_main.ctgm_code='$q'";
...
?>
                        ...
                        <div class="gallery">
                        <img src="<?=$strFileImg1?>" alt="<?=$rowData->ctgm_name?>" class="circle"  style="height:70px; width:70px;"/>
                        </div>
                        </a>
                          </td>
                          <td><?=$rowData->ctgm_name?></td>   
                          <td>
                          <button type="button" onclick="window.location.href='?eltp=<?=$eltp_code_get?>&evltp=<?=$rowData->ctgm_code?>'" class="login100-form-btn" >
							            <?=$txt3?>
                        </button>
                        <?php 
                            if($Chek_resultA >0){
