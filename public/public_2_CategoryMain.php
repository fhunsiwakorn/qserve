...
//user Image
  ...
  $strFileImg=base64_encode_image($pathuserimg);
    ...
    if($Chk_data <=0){
   include ("public_2_CategoryMainAll.php");
    }elseif(!isset($_GET["zone"])){
   include ("public_2_CategoryMainEvaTopic.php");
   }else{
   switch($_GET["zone"]) {
   case "EvaTopic" : include ("public_2_CategoryMainEvaTopic.php");
   break;
   case "EvaStart" : include ("public_2_CategoryMainStart.php");
   break;
   case "EvaAddScore" : include ("public_2_avgScore.php");
   break;
   case "last_step" : include ("public_2_last_step.php");
   break;
   default :  include ("public_2_CategoryMainEvaTopic.php");
     }
   }
