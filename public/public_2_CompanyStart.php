...
$Chek_start =$sql_process->rowsQuery("SELECT evalc_id FROM tbl_evaluation_cach WHERE cmn_code='$cmn_codex' AND eltp_code='$eltp_code_get' AND evltp_code='i' AND  evalc_code='$evalc_code' AND evalc_status='0'");
...
try {
  ...
  // i คือ บริษัท/องค์กรหน่วยงาน
  echo "<script>";
  echo "location.href = '?zone=EvaStart&eltp=$eltp_code&evltp=i'";
  echo "</script>";
...
<!-- i คือ บริษัท/องค์กรหน่วยงาน -->
<input type="hidden" name="evltp" value="i"  /> 
<div class="row" >
