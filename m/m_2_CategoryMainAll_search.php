...
LOCATE('$q', tbl_category_main.ctgm_name) > 0
ORDER BY
...
$num_gen++;
$Chek_resultA =$sql_process->rowsQuery("SELECT evltr_id FROM tbl_evaluation_result WHERE cmn_code='$cmn_code' AND eltp_code='$eltp_code_get' AND evltp_code='$rowData->ctgm_code' AND evltp_user_agent='$useragent' AND DATE(evltp_date)='$date_current'");
