                    ...
                    <div class="card-body">
                      <h4 class="card-title">แบบฟอร์มกรอกข้อมูลบริษัท /องค์กร</h4>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="cmn_name" name="cmn_name" required>
                        </div>
                        
                        <div class="form-group">
                          <label>เบอร์โทร</label> <label style="color:red;">*</label>
                          <input type="text" class="form-control" id="cmn_phone" name="cmn_phone" required>
                        </div>

                        <div class="form-group">
                          <label>ที่อยู่</label> <label style="color:red;">*</label>
                          <input type="text" class="form-control" id="cms_address" name="cms_address" required>
                        </div>

                        <div class="form-group">
                          <label>ไลน์ (รหัส Token)</label> <label style="color:red;">*</label>
                          <input type="text" class="form-control" id="cmn_line" name="cmn_line" required>
                        </div>

                        <div class="form-group">
                          <label>อีเมล</label> 
                          <input type="text" class="form-control" id="cmn_mail" name="cmn_mail" >
                        </div>
...
<li><img  src="../images/images_web/no-logo1.png" alt="อัพโหลดได้เฉพาะไฟล์รูปภาพ !" id="blah"  width="300" height="70"/>
