  ...
  <tbody>
    <tr>
      ...
      <td align="left">
      <button class="btn btn-default btn-block" onclick="window.location.href='?zone=<?=$zone?>&evltp=<?=$evltp_code?>&current_month=<?=$current_month?>&current_year=<?=$current_year?>&page=<?=$page-1?>'">
