...
tbl_category_sub.ctgm_code='$rowDataz->ctgm_code' AND
...
echo"<option value='$rowData1->ctgs_code'";
if ($evltp_code == $rowData1->ctgs_code)
{
echo "SELECTED";
}
echo ">$rowDataz->ctgm_name -> $ctgs_name_main_x -> $rowData1->ctgs_name</option>\n";
}
...
<td align="center" colspan="2">
      ...
      <td align="center"><?php if($chk_value[1]>0 && $total_eva>0){echo number_format($chk_value[1]/$total_eva,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[2]>0 && $total_eva>0){echo number_format($chk_value[2]/$total_eva,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[3]>0 && $total_eva>0){echo number_format($chk_value[3]/$total_eva,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[4]>0 && $total_eva>0){echo number_format($chk_value[4]/$total_eva,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[5]>0 && $total_eva>0){echo number_format($chk_value[5]/$total_eva,2);}else{echo"0.00";}?></td>
    </tr>
<tr>
...
<td align="center" colspan="2">
      ...
      <td align="center"><?php if($chk_value[1]>0 && $total_eva>0){echo number_format(($chk_value1[1]/$total_eva)*1,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[2]>0 && $total_eva>0){echo number_format(($chk_value1[2]/$total_eva)*2,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[3]>0 && $total_eva>0){echo number_format(($chk_value1[3]/$total_eva)*3,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[4]>0 && $total_eva>0){echo number_format(($chk_value1[4]/$total_eva)*4,2);}else{echo"0.00";}?></td>
      <td align="center"><?php if($chk_value[5]>0 && $total_eva>0){echo number_format(($chk_value1[5]/$total_eva)*5,2);}else{echo"0.00";}?></td>
 </tr>
 <tr>
 <td align="center" colspan="2">
        <!-- คะแนนรวม -->
